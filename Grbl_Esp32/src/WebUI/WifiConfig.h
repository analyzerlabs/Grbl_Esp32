...
namespace WebUI {
    ...
    static const char* DEFAULT_STA_SSID = "Smart Solutions Labs";
    static const char* DEFAULT_STA_PWD  = "20120415H";
#else   //!CONNECT_TO_SSID
    static const char* DEFAULT_STA_SSID = "Smart Solutions Labs";
    static const char* DEFAULT_STA_PWD  = "20120415H";
#endif  //CONNECT_TO_SSID
    static const char* DEFAULT_STA_IP            = "192.168.0.15";
    static const char* DEFAULT_STA_GW            = "192.168.0.1";
    static const char* DEFAULT_STA_MK            = "255.255.255.0";
    static const char* DEFAULT_AP_SSID           = "Smart Solutions Labs";
    static const char* DEFAULT_AP_PWD            = "20120415H";
